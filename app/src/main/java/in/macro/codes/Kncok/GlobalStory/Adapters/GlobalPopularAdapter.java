...
public class GlobalPopularAdapter extends RecyclerView.Adapter<GlobalPopularAdapter.Viewholder> {

    private List<String> AllHashTags = new ArrayList<>();
    private List<Story> mGlobalStory = new ArrayList<>();
    private Context mContext;

    public GlobalPopularAdapter(Context context, List<String> allHashTags, List<Story> mGlobalStory) {
